...
export default function About(props) {
    ...
    // }
  return (
    <div classNameName='container' style={{backgroundColor: props.mode==='dark'? "black": "white", color: props.mode==='dark'? "white":"black"}}>
...
{/* <div className='container'>
    <button type="button" className="btn btn-primary my-3" onClick={DarkClick}>{btnText}</button>
</div> */}
